		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			...
			<div class="mb-8">
				<div class="flex items-center gap-3">
					<StarIcon size={32} class="text-accent-600" />
					<a href={viewAllLink} class="transition-colors hover:text-accent-700">
						...
						<a href={formatPermalink(post.date, post.slug.current)} class="block h-full">
							...
							>
								...
								<div class="flex flex-grow flex-col px-6 pt-6 pb-6">
									<h3
										class="mb-3 line-clamp-3 flex-grow text-lg font-bold text-neutral-900 transition-colors group-hover:text-accent-600"
									>
										{post.title}
									</h3>
